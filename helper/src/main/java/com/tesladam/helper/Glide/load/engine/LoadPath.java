...
/**
 * For a given {@link com.tesladam.helper.Glide.load.data.DataFetcher} for a given data class, attempts to
 * fetch the data and then run it through one or more {@link
 * com.tesladam.helper.Glide.load.engine.DecodePath}s.
 *
 ...
 *     {@link com.tesladam.helper.Glide.load.engine.DecodePath}s.
