 ...
 * com.tesladam.helper.Glide.RequestBuilder#into(ImageView)}, a subclass of {@link ImageViewTarget}, or
...
public abstract class CustomTarget<T> implements Target<T> {
   ...
   * {@link com.tesladam.helper.Glide.request.RequestOptions#override(int)}. In all other cases, prefer
   ...
   * com.tesladam.helper.Glide.request.RequestOptions#override(int)} in the request).
   *
