...
public interface Transformation<T> extends Key {
   ...
   * com.tesladam.helper.Glide.load.engine.DiskCacheStrategy#NONE} or make sure {@link
   ...
   *     com.tesladam.helper.Glide.request.target.Target#SIZE_ORIGINAL} to indicate the original resource
   *     width.
