...
public abstract class DiskCacheStrategy {
   ...
   * com.tesladam.helper.Glide.load.data.DataFetcher} and the {@link
   * com.tesladam.helper.Glide.load.EncodeStrategy} of the {@link com.tesladam.helper.Glide.load.ResourceEncoder}
   * (if an {@link com.tesladam.helper.Glide.load.ResourceEncoder} is available).
   */
   ...
   *     com.tesladam.helper.Glide.load.ResourceEncoder} will use to encode the resource.
   */
