 ...
 * com.tesladam.helper.Glide.load.model.GlideUrl} objects and then uses the wrapped {@link
 * com.tesladam.helper.Glide.load.model.ModelLoader} for {@link com.tesladam.helper.Glide.load.model.GlideUrl}s to
 * load the data.
 */
