 ...
 * com.tesladam.helper.Glide.GlideBuilder} and registering {@link com.tesladam.helper.Glide.load.model.ModelLoader
 * ModelLoaders}.
 *
 ...
 *       Registry#prepend(Class, Class, com.tesladam.helper.Glide.load.ResourceDecoder)} for each {@link
 *       com.tesladam.helper.Glide.load.model.ModelLoader} you'd like to register:
 *       <pre>
 *                  <code>
 ...
 *       <pre>{@code
 * -keepnames class * com.tesladam.helper.Glide.samples.flickr.FlickrGlideModule
 * }</pre>
 ...
 *       <pre>{@code
 * <meta-data
 *     android:name="com.tesladam.helper.Glide.samples.flickr.FlickrGlideModule"
