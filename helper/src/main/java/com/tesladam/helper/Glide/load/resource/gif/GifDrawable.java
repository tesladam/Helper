...
import static com.tesladam.helper.Glide.gifdecoder.GifDecoder.TOTAL_ITERATION_COUNT_FOREVER;
...
public class GifDrawable extends Drawable
   ...
   * @param frameTransformation An {@link com.tesladam.helper.Glide.load.Transformation} that can be
   *     applied to each frame.
   * @param targetFrameWidth The desired width of the frames displayed by this drawable (the width
   *     of the view or {@link com.tesladam.helper.Glide.request.target.Target} this drawable is being
   *     loaded into).
   * @param targetFrameHeight The desired height of the frames displayed by this drawable (the
   *     height of the view or {@link com.tesladam.helper.Glide.request.target.Target} this drawable is
   *     being loaded into).
   * @param gifDecoder The decoder to use to decode GIF data.
   * @param firstFrame The decoded and transformed first frame of this GIF.
   * @see #setFrameTransformation(com.tesladam.helper.Glide.load.Transformation, android.graphics.Bitmap)
