...
import com.tesladam.helper.Glide.load.data.DataFetcher.DataCallback;
import com.tesladam.helper.Glide.load.model.ModelLoader;
import com.tesladam.helper.Glide.load.model.ModelLoader.LoadData;
import com.tesladam.helper.Glide.util.LogTime;
import com.tesladam.helper.Glide.util.Synthetic;
import java.util.Collections;

/**
 * Generates {@link com.tesladam.helper.Glide.load.data.DataFetcher DataFetchers} from original source data
 * using registered {@link com.tesladam.helper.Glide.load.model.ModelLoader ModelLoaders} and the model
