 ...
 * android.graphics.Bitmap}s returned by {@link com.tesladam.helper.Glide.load.ResourceDecoder}s.
 *
 * <p>Note - In some cases it may not be possible to obey the requested setting, not all {@link
 * com.tesladam.helper.Glide.load.resource.bitmap.Downsampler}s support setting formats and certain images
...
public enum DecodeFormat {
  /**
   * Bitmaps returned by the {@link com.tesladam.helper.Glide.load.ResourceDecoder}. should return {@link
   ...
   * use {@link com.tesladam.helper.Glide.request.RequestOptions#disallowHardwareConfig()}.
   *
