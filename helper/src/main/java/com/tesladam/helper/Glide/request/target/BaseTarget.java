package com.tesladam.helper.Glide.request.target;
...
/**
 * A base {@link Target} for loading {@link com.tesladam.helper.Glide.load.engine.Resource}s that provides
 ...
 * {@link com.tesladam.helper.Glide.load.engine.Resource} loaded into it using {@link
 * com.tesladam.helper.Glide.RequestManager#clear(Target)}.
 *
 * <p>For loading {@link com.tesladam.helper.Glide.load.engine.Resource}s into {@link android.view.View}s,
 * {@link com.tesladam.helper.Glide.request.target.ViewTarget} or {@link
 * com.tesladam.helper.Glide.request.target.ImageViewTarget} are preferable.
 *
