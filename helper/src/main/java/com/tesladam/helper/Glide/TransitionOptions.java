...
import com.tesladam.helper.Glide.request.transition.NoTransition;
import com.tesladam.helper.Glide.request.transition.TransitionFactory;
import com.tesladam.helper.Glide.request.transition.ViewAnimationFactory;
import com.tesladam.helper.Glide.request.transition.ViewPropertyAnimationFactory;
import com.tesladam.helper.Glide.request.transition.ViewPropertyTransition;
...
public abstract class TransitionOptions<
   ...
   *
   * @param animator The {@link com.tesladam.helper.Glide.request.transition.ViewPropertyTransition
   *     .Animator} to run.
   * @return This request builder.
   */
  @NonNull
   ...
   * com.tesladam.helper.Glide.request.transition.Transition} for each request started with these {@code
   * TransitionOptions}.
   *
   * @return This request builder.
   */
