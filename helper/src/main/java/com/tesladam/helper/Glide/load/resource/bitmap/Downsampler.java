...
import com.tesladam.helper.Glide.load.ImageHeaderParser.ImageType;
import com.tesladam.helper.Glide.load.Option;
import com.tesladam.helper.Glide.load.Options;
import com.tesladam.helper.Glide.load.PreferredColorSpace;
...
import com.tesladam.helper.Glide.load.resource.bitmap.DownsampleStrategy.SampleSizeRounding;
...
public final class Downsampler {
  ...
  public static final Option<DecodeFormat> DECODE_FORMAT =
      Option.memory(
          "com.tesladam.helper.Glide.load.resource.bitmap.Downsampler.DecodeFormat", DecodeFormat.DEFAULT);
  ...
  public static final Option<PreferredColorSpace> PREFERRED_COLOR_SPACE =
      Option.memory(
          "com.tesladam.helper.Glide.load.resource.bitmap.Downsampler.PreferredColorSpace",
          PreferredColorSpace.SRGB);
  /**
   * Indicates the {@link com.tesladam.helper.Glide.load.resource.bitmap.DownsampleStrategy} option that
  ...
  public static final Option<Boolean> FIX_BITMAP_SIZE_TO_REQUESTED_DIMENSIONS =
      Option.memory("com.tesladam.helper.Glide.load.resource.bitmap.Downsampler.FixBitmapSize", false);
   ...
   * com.tesladam.helper.Glide.GlideBuilder#setDefaultRequestOptions(RequestOptions)}.
   *
   * <p>This option is ignored unless we're on Android O+.
   */
  public static final Option<Boolean> ALLOW_HARDWARE_CONFIG =
      Option.memory(
          "com.tesladam.helper.Glide.load.resource.bitmap.Downsampler.AllowHardwareDecode", false);
   ...
   * provided {@link com.tesladam.helper.Glide.load.resource.bitmap.DownsampleStrategy} option.
   *
   ...
   * com.tesladam.helper.Glide.load.engine.bitmap_recycle.BitmapPool} whose dimensions exactly match those
