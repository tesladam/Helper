...
import com.tesladam.helper.Glide.load.data.InputStreamRewinder;
import com.tesladam.helper.Glide.load.data.ParcelFileDescriptorRewinder;
import com.tesladam.helper.Glide.load.engine.Engine;
...
import com.tesladam.helper.Glide.load.engine.cache.MemoryCache;
import com.tesladam.helper.Glide.load.engine.prefill.BitmapPreFiller;
import com.tesladam.helper.Glide.load.engine.prefill.PreFillType;
import com.tesladam.helper.Glide.load.engine.prefill.PreFillType.Builder;
import com.tesladam.helper.Glide.load.model.AssetUriLoader;
import com.tesladam.helper.Glide.load.model.ByteArrayLoader;
import com.tesladam.helper.Glide.load.model.ByteBufferEncoder;
import com.tesladam.helper.Glide.load.model.ByteBufferFileLoader;
import com.tesladam.helper.Glide.load.model.DataUrlLoader;
import com.tesladam.helper.Glide.load.model.FileLoader;
import com.tesladam.helper.Glide.load.model.GlideUrl;
import com.tesladam.helper.Glide.load.model.MediaStoreFileLoader;
import com.tesladam.helper.Glide.load.model.ResourceLoader;
import com.tesladam.helper.Glide.load.model.StreamEncoder;
import com.tesladam.helper.Glide.load.model.StringLoader;
import com.tesladam.helper.Glide.load.model.UnitModelLoader;
import com.tesladam.helper.Glide.load.model.UriLoader;
import com.tesladam.helper.Glide.load.model.UrlUriLoader;
import com.tesladam.helper.Glide.load.model.stream.HttpGlideUrlLoader;
import com.tesladam.helper.Glide.load.model.stream.HttpUriLoader;
import com.tesladam.helper.Glide.load.model.stream.MediaStoreImageThumbLoader;
import com.tesladam.helper.Glide.load.model.stream.MediaStoreVideoThumbLoader;
import com.tesladam.helper.Glide.load.model.stream.QMediaStoreUriLoader;
import com.tesladam.helper.Glide.load.model.stream.UrlLoader;
import com.tesladam.helper.Glide.load.resource.bitmap.BitmapDrawableDecoder;
import com.tesladam.helper.Glide.load.resource.bitmap.BitmapDrawableEncoder;
import com.tesladam.helper.Glide.load.resource.bitmap.BitmapEncoder;
import com.tesladam.helper.Glide.load.resource.bitmap.ByteBufferBitmapDecoder;
import com.tesladam.helper.Glide.load.resource.bitmap.ByteBufferBitmapImageDecoderResourceDecoder;
import com.tesladam.helper.Glide.load.resource.bitmap.DefaultImageHeaderParser;
import com.tesladam.helper.Glide.load.resource.bitmap.Downsampler;
import com.tesladam.helper.Glide.load.resource.bitmap.ExifInterfaceImageHeaderParser;
import com.tesladam.helper.Glide.load.resource.bitmap.InputStreamBitmapImageDecoderResourceDecoder;
import com.tesladam.helper.Glide.load.resource.bitmap.ParcelFileDescriptorBitmapDecoder;
import com.tesladam.helper.Glide.load.resource.bitmap.ResourceBitmapDecoder;
import com.tesladam.helper.Glide.load.resource.bitmap.StreamBitmapDecoder;
import com.tesladam.helper.Glide.load.resource.bitmap.UnitBitmapDecoder;
import com.tesladam.helper.Glide.load.resource.bitmap.VideoDecoder;
import com.tesladam.helper.Glide.load.resource.bytes.ByteBufferRewinder;
import com.tesladam.helper.Glide.load.resource.drawable.ResourceDrawableDecoder;
import com.tesladam.helper.Glide.load.resource.drawable.UnitDrawableDecoder;
import com.tesladam.helper.Glide.load.resource.file.FileDecoder;
import com.tesladam.helper.Glide.load.resource.gif.ByteBufferGifDecoder;
import com.tesladam.helper.Glide.load.resource.gif.GifDrawable;
import com.tesladam.helper.Glide.load.resource.gif.GifDrawableEncoder;
import com.tesladam.helper.Glide.load.resource.gif.GifFrameResourceDecoder;
import com.tesladam.helper.Glide.load.resource.gif.StreamGifDecoder;
import com.tesladam.helper.Glide.load.resource.transcode.BitmapBytesTranscoder;
import com.tesladam.helper.Glide.load.resource.transcode.BitmapDrawableTranscoder;
import com.tesladam.helper.Glide.load.resource.transcode.DrawableBytesTranscoder;
import com.tesladam.helper.Glide.load.resource.transcode.GifDrawableBytesTranscoder;
import com.tesladam.helper.Glide.manager.ConnectivityMonitorFactory;
import com.tesladam.helper.Glide.manager.RequestManagerRetriever;
import com.tesladam.helper.Glide.module.ManifestParser;
import com.tesladam.helper.Glide.request.RequestListener;
import com.tesladam.helper.Glide.request.RequestOptions;
import com.tesladam.helper.Glide.request.target.ImageViewTargetFactory;
import com.tesladam.helper.Glide.request.target.Target;
 ...
 * com.tesladam.helper.Glide.load.engine.cache.DiskCache} and {@link MemoryCache}.
 */
public class Glide implements ComponentCallbacks2 {
  ...
  private static void initializeGlide(
    ...
    List<com.tesladam.helper.Glide.module.GlideModule> manifestModules = Collections.emptyList();
    ...
    if (annotationGeneratedModule != null
      ...
      Iterator<com.tesladam.helper.Glide.module.GlideModule> iterator = manifestModules.iterator();
      while (iterator.hasNext()) {
        com.tesladam.helper.Glide.module.GlideModule current = iterator.next();
    ...
    if (Log.isLoggable(TAG, Log.DEBUG)) {
      for (com.tesladam.helper.Glide.module.GlideModule glideModule : manifestModules) {
    ...
    for (com.tesladam.helper.Glide.module.GlideModule module : manifestModules) {
    ...
    try {
      Class<GeneratedAppGlideModule> clazz =
          (Class<GeneratedAppGlideModule>)
              Class.forName("com.tesladam.helper.Glide.GeneratedAppGlideModuleImpl");
      result =
  ...
  /**
   * Returns the {@link com.tesladam.helper.Glide.load.engine.bitmap_recycle.BitmapPool} used to
   ...
   * com.tesladam.helper.Glide.load.ResourceDecoder}s and {@link com.tesladam.helper.Glide.load.Transformation}s.
