 ...
 * com.tesladam.helper.Glide.RequestManager} that can be used to start, stop and manage Glide requests
 * started for targets the fragment or activity this fragment is a child of.
 *
 * @see com.tesladam.helper.Glide.manager.SupportRequestManagerFragment
 * @see com.tesladam.helper.Glide.manager.RequestManagerRetriever
 * @see com.tesladam.helper.Glide.RequestManager
 */
...
public class RequestManagerFragment extends Fragment {
  ...
  /**
   * Sets the current {@link com.tesladam.helper.Glide.RequestManager}.
   *
  ...
  /** Returns the current {@link com.tesladam.helper.Glide.RequestManager} or null if none exists. */
  @Nullable
