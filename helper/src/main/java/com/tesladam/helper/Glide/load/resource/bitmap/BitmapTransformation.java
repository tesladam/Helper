...
/**
 * A simple {@link com.tesladam.helper.Glide.load.Transformation} for transforming {@link
 * android.graphics.Bitmap}s that abstracts away dealing with {@link
 * com.tesladam.helper.Glide.load.engine.Resource} objects for subclasses.
 *
 ...
 *     private static final String ID = "com.tesladam.helper.Glide.transformations.FillSpace";
...
public abstract class BitmapTransformation implements Transformation<Bitmap> {
   ...
   * com.tesladam.helper.Glide.request.target.Target#SIZE_ORIGINAL}, this class converts them to be the
   * size of the Bitmap we're going to transform before calling this method.
   *
   * @param pool A {@link com.tesladam.helper.Glide.load.engine.bitmap_recycle.BitmapPool} that can be used
