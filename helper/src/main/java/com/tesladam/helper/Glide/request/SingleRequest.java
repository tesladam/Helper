...
import com.tesladam.helper.Glide.GlideContext;
...
import com.tesladam.helper.Glide.load.resource.drawable.DrawableDecoderCompat;
import com.tesladam.helper.Glide.request.target.SizeReadyCallback;
import com.tesladam.helper.Glide.request.target.Target;
import com.tesladam.helper.Glide.request.transition.Transition;
import com.tesladam.helper.Glide.request.transition.TransitionFactory;
...
/**
 * A {@link Request} that loads a {@link com.tesladam.helper.Glide.load.engine.Resource} into a given
 * {@link Target}.
 *
