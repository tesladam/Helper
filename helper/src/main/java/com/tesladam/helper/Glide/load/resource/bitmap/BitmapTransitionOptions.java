...
import com.tesladam.helper.Glide.TransitionOptions;
import com.tesladam.helper.Glide.request.transition.BitmapTransitionFactory;
import com.tesladam.helper.Glide.request.transition.DrawableCrossFadeFactory;
...
public final class BitmapTransitionOptions
   ...
   *
   * @see com.tesladam.helper.Glide.GenericTransitionOptions#with(TransitionFactory)
   */
  @NonNull
   ...
   * @see com.tesladam.helper.Glide.request.transition.DrawableCrossFadeFactory.Builder
   */
  @NonNull
