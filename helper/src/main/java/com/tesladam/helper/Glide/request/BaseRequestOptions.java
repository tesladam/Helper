package com.tesladam.helper.Glide.request;
...
import com.tesladam.helper.Glide.load.MultiTransformation;
...
import com.tesladam.helper.Glide.load.resource.bitmap.CenterCrop;
import com.tesladam.helper.Glide.load.resource.bitmap.CenterInside;
import com.tesladam.helper.Glide.load.resource.bitmap.CircleCrop;
import com.tesladam.helper.Glide.load.resource.bitmap.DownsampleStrategy;
import com.tesladam.helper.Glide.load.resource.bitmap.Downsampler;
import com.tesladam.helper.Glide.load.resource.bitmap.DrawableTransformation;
import com.tesladam.helper.Glide.load.resource.bitmap.FitCenter;
...
import com.tesladam.helper.Glide.load.resource.gif.GifDrawableTransformation;
import com.tesladam.helper.Glide.load.resource.gif.GifOptions;
import com.tesladam.helper.Glide.signature.EmptySignature;
import com.tesladam.helper.Glide.util.CachedHashCodeArrayMap;
 ...
 * com.tesladam.helper.Glide.RequestBuilder}.
 *
...
public abstract class BaseRequestOptions<T extends BaseRequestOptions<T>> implements Cloneable {
  ...
  /**
   * Applies a multiplier to the {@link com.tesladam.helper.Glide.request.target.Target}'s size before
   ...
   *     com.tesladam.helper.Glide.request.target.Target}'s dimensions when loading the resource.
   ...
   * com.tesladam.helper.Glide.RequestBuilder#load(Object)} is {@code null}.
   *
  ...
  /**
   * Overrides the {@link com.tesladam.helper.Glide.request.target.Target}'s width and height with the
   ...
   * @return This request builder.
   * @see com.tesladam.helper.Glide.signature.ObjectKey
   */
  @NonNull
  @CheckResult
   ...
   * com.tesladam.helper.Glide.load.resource.bitmap.BitmapEncoder#COMPRESSION_FORMAT}.
   */
  @NonNull
  @CheckResult
   ...
   * com.tesladam.helper.Glide.load.resource.bitmap.DownsampleStrategy.CenterOutside} can safely use {@link
   ...
   * com.tesladam.helper.Glide.load.model.stream.HttpGlideUrlLoader}. If you use any other networking
   * library including Glide's Volley or OkHttp integration libraries, this option will be ignored.
   *
   * @see com.tesladam.helper.Glide.load.model.stream.HttpGlideUrlLoader#TIMEOUT
  ...
  /**
   * Applies {@link com.tesladam.helper.Glide.load.resource.bitmap.CenterCrop} to all default types, and
  ...
  /**
   * Applies {@link com.tesladam.helper.Glide.load.resource.bitmap.CenterInside} to all default types,
   ...
   * com.tesladam.helper.Glide.load.resource.gif.GifDrawable}) and throws an exception if asked to
   ...
   * Applies the given {@link Transformation} for {@link Bitmap Bitmaps} to the default types
   * ({@link Bitmap}, {@link android.graphics.drawable.BitmapDrawable}, and {@link
   * com.tesladam.helper.Glide.load.resource.gif.GifDrawable}) and ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param transformation Any {@link Transformation} for {@link Bitmap}s.
   ...
   * com.tesladam.helper.Glide.TransitionOptions#dontTransition()}
   */
  // Guaranteed to modify the current object by the isAutoCloneEnabledCheck.
  @SuppressWarnings("CheckResult")
  @NonNull
