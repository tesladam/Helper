...
public interface RequestListener<R> {
   ...
   * use {@link com.tesladam.helper.Glide.RequestBuilder#error(RequestBuilder)} instead.
   *
   ...
   * Target#onResourceReady(Object, com.tesladam.helper.Glide.request.transition.Transition)}.
   *
   * <p>For threading guarantees, see the class comment.
   *
