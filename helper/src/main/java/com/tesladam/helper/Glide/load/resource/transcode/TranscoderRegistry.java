...
/**
 * A class that allows {@link com.tesladam.helper.Glide.load.resource.transcode.ResourceTranscoder}s to be
...
public class TranscoderRegistry {
  ...
  /**
   * Registers the given {@link com.tesladam.helper.Glide.load.resource.transcode.ResourceTranscoder} using
   ...
   * com.tesladam.helper.Glide.load.resource.transcode.ResourceTranscoder} for the given classes.
   *
