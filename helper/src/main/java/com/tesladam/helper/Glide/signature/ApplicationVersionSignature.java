package com.tesladam.helper.Glide.signature;
...
/**
 * A utility class for obtaining a {@link com.tesladam.helper.Glide.load.Key} signature containing the
...
public final class ApplicationVersionSignature {
  ...
  /**
   * Returns the signature {@link com.tesladam.helper.Glide.load.Key} for version code of the Application
