...
/** A request that loads a resource for an {@link com.tesladam.helper.Glide.request.target.Target}. */
public interface Request {
   ...
   * com.tesladam.helper.Glide.request.target.Target}s (for example). Using a similar but different method
