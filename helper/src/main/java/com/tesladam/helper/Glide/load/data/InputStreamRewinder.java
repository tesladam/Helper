...
import com.tesladam.helper.Glide.load.resource.bitmap.RecyclableBufferedInputStream;
...
public final class InputStreamRewinder implements DataRewinder<InputStream> {
  ...
  /**
   * Factory for producing {@link com.tesladam.helper.Glide.load.data.InputStreamRewinder}s from {@link
