...
import com.tesladam.helper.Glide.Glide.RequestOptionsFactory;
import com.tesladam.helper.Glide.load.DataSource;
import com.tesladam.helper.Glide.load.engine.Engine;
import com.tesladam.helper.Glide.load.engine.GlideException;
...
import com.tesladam.helper.Glide.load.engine.bitmap_recycle.LruArrayPool;
import com.tesladam.helper.Glide.load.engine.bitmap_recycle.LruBitmapPool;
import com.tesladam.helper.Glide.load.engine.cache.DiskCache;
import com.tesladam.helper.Glide.load.engine.cache.InternalCacheDiskCacheFactory;
import com.tesladam.helper.Glide.load.engine.cache.LruResourceCache;
import com.tesladam.helper.Glide.load.engine.cache.MemoryCache;
import com.tesladam.helper.Glide.load.engine.cache.MemorySizeCalculator;
import com.tesladam.helper.Glide.load.engine.executor.GlideExecutor;
import com.tesladam.helper.Glide.load.resource.bitmap.HardwareConfigState;
import com.tesladam.helper.Glide.manager.ConnectivityMonitorFactory;
import com.tesladam.helper.Glide.manager.DefaultConnectivityMonitorFactory;
import com.tesladam.helper.Glide.manager.RequestManagerRetriever;
import com.tesladam.helper.Glide.manager.RequestManagerRetriever.RequestManagerFactory;
import com.tesladam.helper.Glide.request.BaseRequestOptions;
...
public final class GlideBuilder {
  ...
  /**
   * Sets the {@link com.tesladam.helper.Glide.load.engine.bitmap_recycle.BitmapPool} implementation to use
  ...
  /**
   * Sets the {@link com.tesladam.helper.Glide.load.engine.cache.MemoryCache} implementation to store
   * {@link com.tesladam.helper.Glide.load.engine.Resource}s that are not currently in use.
   *
  ...
  /**
   * Sets the {@link com.tesladam.helper.Glide.load.engine.cache.DiskCache.Factory} implementation to use
   * to construct the {@link com.tesladam.helper.Glide.load.engine.cache.DiskCache} to use to store {@link
   * com.tesladam.helper.Glide.load.engine.Resource} data on disk.
   *
   ...
   * com.tesladam.helper.Glide.load.engine.Resource}s that are not already in the cache.
   *
  ...
  /**
   * Sets the {@link GlideExecutor} to use when retrieving {@link
   * com.tesladam.helper.Glide.load.engine.Resource}s that are currently in Glide's disk caches.
   *
   ...
   * of {@link com.tesladam.helper.Glide.load.resource.gif.GifDrawable}s.
   *
   ...
   * {@link com.tesladam.helper.Glide.load.resource.gif.GifDrawable} or {@link
  ...
  /**
   * Sets the {@link com.tesladam.helper.Glide.manager.ConnectivityMonitorFactory} to use to notify {@link
   * com.tesladam.helper.Glide.RequestManager} of connectivity events. If not set {@link
   * com.tesladam.helper.Glide.manager.DefaultConnectivityMonitorFactory} would be used.
   *
   ...
   * com.tesladam.helper.Glide.request.target.Target}s which are subsequently de-referenced and garbage
   ...
   * load resources into {@link com.tesladam.helper.Glide.request.target.Target}s and then never clear the
   * {@link com.tesladam.helper.Glide.request.target.Target}. To do so, Glide uses {@link
   * java.lang.ref.WeakReference}s to track resources that belong to {@link
   * com.tesladam.helper.Glide.request.target.Target}s that haven't yet been cleared. Setting this method
   * to {@code true} allows Glide to also maintain a hard reference to the underlying resource so
   * that if the {@link com.tesladam.helper.Glide.request.target.Target} is garbage collected, Glide can
   ...
   * resources into {@link com.tesladam.helper.Glide.request.target.Target}s but never clear them.
   *
   ...
   * com.tesladam.helper.Glide.request.target.Target} used to load the {@link Bitmap}. However, if you set
   ...
   * com.tesladam.helper.Glide.request.target.Target}s when you're done with the corresponding resource.
   * Clearing {@link com.tesladam.helper.Glide.request.target.Target}s allows Glide to maximize resource
   ...
   * com.tesladam.helper.Glide.load.engine.GlideException#setOrigin(Exception)} for failed requests.
   *
   ...
   * com.tesladam.helper.Glide.load.resource.bitmap.Downsampler} and {@link android.graphics.BitmapFactory}
   ...
   * may still be used as part of {@link com.tesladam.helper.Glide.load.Transformation}s because {@link
   * android.graphics.ImageDecoder} does not support Bitmap re-use.
   *
   * <p>When this flag is enabled {@link
   * com.tesladam.helper.Glide.load.resource.bitmap.Downsampler#FIX_BITMAP_SIZE_TO_REQUESTED_DIMENSIONS} is
   * ignored. All other {@link com.tesladam.helper.Glide.load.resource.bitmap.Downsampler} flags are
