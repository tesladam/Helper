 ...
 * differ depending on the {@link com.tesladam.helper.Glide.load.ResourceDecoder} using the strategy and
 ...
 * com.tesladam.helper.Glide.load.Transformation} either instead or in addition to a {@code
 * DownsampleStrategy}.
 *
 * <p>Some differences between versions of Android and {@link
 * com.tesladam.helper.Glide.load.ResourceDecoder}s are listed below, but the list is not comprehensive
 ...
 * is supported. To preserve the potential for a {@link com.tesladam.helper.Glide.load.Transformation} to
...
public abstract class DownsampleStrategy {
  ...
  public static final Option<DownsampleStrategy> OPTION =
      Option.memory(
          "com.tesladam.helper.Glide.load.resource.bitmap.Downsampler.DownsampleStrategy", DEFAULT);
