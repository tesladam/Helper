...
import com.tesladam.helper.Glide.load.data.DataRewinder;
import com.tesladam.helper.Glide.load.data.DataRewinderRegistry;
import com.tesladam.helper.Glide.load.engine.DecodePath;
import com.tesladam.helper.Glide.load.engine.LoadPath;
import com.tesladam.helper.Glide.load.engine.Resource;
import com.tesladam.helper.Glide.load.model.ModelLoader;
import com.tesladam.helper.Glide.load.model.ModelLoaderFactory;
import com.tesladam.helper.Glide.load.model.ModelLoaderRegistry;
import com.tesladam.helper.Glide.load.resource.transcode.ResourceTranscoder;
import com.tesladam.helper.Glide.load.resource.transcode.TranscoderRegistry;
import com.tesladam.helper.Glide.provider.EncoderRegistry;
import com.tesladam.helper.Glide.provider.ImageHeaderParserRegistry;
import com.tesladam.helper.Glide.provider.LoadPathCache;
import com.tesladam.helper.Glide.provider.ModelToResourceClassCache;
import com.tesladam.helper.Glide.provider.ResourceDecoderRegistry;
import com.tesladam.helper.Glide.provider.ResourceEncoderRegistry;
...
public class Registry {
   ...
   *     {@link com.tesladam.helper.Glide.load.resource.gif.GifDrawable} etc).
   ...
   * com.tesladam.helper.Glide.load.resource.gif.GifDrawable} and any other subclass.
   *
  ...
  /**
   * Registers a new {@link com.tesladam.helper.Glide.load.data.DataRewinder.Factory} to handle a
  ...
  /**
   * Thrown when no {@link com.tesladam.helper.Glide.load.model.ModelLoader} is registered for a given
   * model class.
   */
