...
import static com.tesladam.helper.Glide.request.RequestOptions.diskCacheStrategyOf;
import static com.tesladam.helper.Glide.request.RequestOptions.signatureOf;
import static com.tesladam.helper.Glide.request.RequestOptions.skipMemoryCacheOf;
...
import com.tesladam.helper.Glide.load.engine.DiskCacheStrategy;
import com.tesladam.helper.Glide.request.BaseRequestOptions;
import com.tesladam.helper.Glide.request.ErrorRequestCoordinator;
import com.tesladam.helper.Glide.request.FutureTarget;
import com.tesladam.helper.Glide.request.Request;
import com.tesladam.helper.Glide.request.RequestCoordinator;
import com.tesladam.helper.Glide.request.RequestFutureTarget;
import com.tesladam.helper.Glide.request.RequestListener;
import com.tesladam.helper.Glide.request.RequestOptions;
import com.tesladam.helper.Glide.request.SingleRequest;
import com.tesladam.helper.Glide.request.ThumbnailRequestCoordinator;
import com.tesladam.helper.Glide.request.target.PreloadTarget;
import com.tesladam.helper.Glide.request.target.Target;
import com.tesladam.helper.Glide.request.target.ViewTarget;
import com.tesladam.helper.Glide.signature.AndroidResourceSignature;
import com.tesladam.helper.Glide.util.Executors;
 ...
 *     com.tesladam.helper.Glide.request.target.Target}.
 */
// Public API.
...
public class RequestBuilder<TranscodeType> extends BaseRequestOptions<RequestBuilder<TranscodeType>>
   ...
   * com.tesladam.helper.Glide.load.model.ModelLoader}, {@link com.tesladam.helper.Glide.load.ResourceDecoder},
   * and {@link com.tesladam.helper.Glide.load.Transformation}s. However, {@link
   * com.tesladam.helper.Glide.request.RequestOptions#placeholder(int)} and {@link
   * com.tesladam.helper.Glide.request.RequestOptions#error(int)}, and {@link #listener(RequestListener)}
   ...
   * by default, consider registering a custom {@link com.tesladam.helper.Glide.load.model.ModelLoader} or
   * {@link com.tesladam.helper.Glide.load.ResourceDecoder} instead of using this method.
   *
   ...
   * com.tesladam.helper.Glide.load.model.ModelLoader} or {@link com.tesladam.helper.Glide.load.ResourceDecoder}
   ...
   * com.tesladam.helper.Glide.request.RequestOptions#signature(com.tesladam.helper.Glide.load.Key)} to mixin a
   ...
   * com.tesladam.helper.Glide.load.engine.DiskCacheStrategy#NONE} and/or {@link
   * com.tesladam.helper.Glide.request.RequestOptions#skipMemoryCache(boolean)} may be appropriate.
   *
   * @see #load(Object)
   * @param string A file path, or a uri or url handled by {@link
   *     com.tesladam.helper.Glide.load.model.UriLoader}.
   */
  @NonNull
  @Override
  @CheckResult
   ...
   * com.tesladam.helper.Glide.load.model.ModelLoaderFactory} currently registered or {@link Integer} to
   * load the image represented by the given {@link Integer} resource id. Defaults to {@link
   * com.tesladam.helper.Glide.load.model.ResourceLoader} to load resource id models.
   *
   ...
   * consider using {@link com.tesladam.helper.Glide.load.engine.DiskCacheStrategy#NONE} via {@link
   * RequestOptions#diskCacheStrategy(com.tesladam.helper.Glide.load.engine.DiskCacheStrategy)} during
   * development, and re-enabling the default {@link
   * com.tesladam.helper.Glide.load.engine.DiskCacheStrategy#RESOURCE} for release builds.
   *
   ...
   * com.tesladam.helper.Glide.load.Transformation}s to these {@link Drawable}s by either extracting the
   ...
   * transformed (other than {@link com.tesladam.helper.Glide.load.resource.gif.GifDrawable}). To avoid
   ...
   * method, especially in conjunction with {@link com.tesladam.helper.Glide.load.Transformation}s with
   * caution for non-{@link Bitmap} {@link Drawable}s.
   *
   * @see #load(Integer)
   * @see com.tesladam.helper.Glide.signature.AndroidResourceSignature
   */
  @NonNull
  @CheckResult
  @Override
   ...
   * @return The {@link com.tesladam.helper.Glide.request.target.Target} used to wrap the given {@link
   *     ImageView}.
   */
  @NonNull
   ...
   *     overridden by {@link com.tesladam.helper.Glide.request.RequestOptions#override(int, int)} if
   *     previously called.
   ...
   *     RequestManager#clear(Target)}.
   * @see com.tesladam.helper.Glide.ListPreloader
   */
  @NonNull
