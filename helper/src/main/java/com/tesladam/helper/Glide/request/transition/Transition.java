package com.tesladam.helper.Glide.request.transition;
 ...
 * com.tesladam.helper.Glide.request.target.Target}s in across resource types. Targets that wrap views will
