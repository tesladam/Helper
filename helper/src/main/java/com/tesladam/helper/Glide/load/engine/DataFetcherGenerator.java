...
/**
 * Generates a series of {@link com.tesladam.helper.Glide.load.data.DataFetcher DataFetchers} using
 * registered {@link com.tesladam.helper.Glide.load.model.ModelLoader ModelLoaders} and a model.
 */
interface DataFetcherGenerator {
  /**
   * Called when the generator has finished loading data from a {@link
   * com.tesladam.helper.Glide.load.data.DataFetcher}.
   */
  ...
  /**
   * Attempts to a single new {@link com.tesladam.helper.Glide.load.data.DataFetcher} and returns true if a
   * {@link com.tesladam.helper.Glide.load.data.DataFetcher} was started, and false otherwise.
   */
  boolean startNext();
