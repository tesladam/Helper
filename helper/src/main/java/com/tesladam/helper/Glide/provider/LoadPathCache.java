...
import com.tesladam.helper.Glide.load.resource.transcode.UnitTranscoder;
import com.tesladam.helper.Glide.util.MultiClassKey;
import java.util.Collections;
import java.util.concurrent.atomic.AtomicReference;

/**
 * Maintains a cache of data, resource, and transcode classes to available {@link
 * com.tesladam.helper.Glide.load.engine.LoadPath}s capable of decoding with the requested types.
 */
