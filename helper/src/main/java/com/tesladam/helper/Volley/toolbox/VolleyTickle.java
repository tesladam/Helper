...
import com.tesladam.helper.Volley.RequestTickle;
...
public class VolleyTickle {
    ...
    /**
     * Creates a default instance of the worker pool and calls {@link com.tesladam.helper.Volley.RequestTickle#start()} on it.
     *
     * @param context A {@link android.content.Context} to use for creating the cache dir.
     * @param stack An {@link com.tesladam.helper.Volley.toolbox.HttpStack} to use for the network, or null for default.
     * @return A started {@link com.tesladam.helper.Volley.RequestTickle} instance.
     */
